...
namespace Calametra.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915070731_AddRegisterAcquisitionAndSupersession")]
    partial class AddRegisterAcquisitionAndSupersession
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Calametra.Domain.Administrative.LguCodeLink", b =>
                {
                    ...
                    b.HasIndex("LguId", "HistoricalPsgcCode")
                        .IsUnique()
                        .HasDatabaseName("ix_lgu_code_links_lgu_id_historical_psgc_code");
